...
const Element = ({pageTitle}) => {
    const router = useRouter()
      ...
      useEffect(() => {
        ...
        axios.post("http://localhost:4000/api/offer/get-offers",{},{
            headers:{
            }
        })
          .then((response) => {
      ...
      const handleDelete = (id) => {
        ...
        const response  = axios.post('http://localhost:4000/api/offer/delete-offer',payload, {
            headers: { }
        });
        ...
        <div className="col-12">
          <div className="card">
            <div className="card-header" style={{ display:'flex', justifyContent:'space-between'}}>
              ...
              <Button variant="contained" color="success" onClick={()=> router.push('/offer/createOffer')}>
                Create
              </Button>
            </div>
