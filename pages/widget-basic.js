                  ...
                  {widgetData &&
                    widgetData.timeline.map((timeline, i) => (
                      <li key={i}>
                        ...
                        <Link className="timeline-panel text-muted" href="#" passHref>
                      ...
                      <li key={i}>
                        <div className="timeline-panel">
                          {notifications.profile.img ? (
                            ...
                            <div
                              className={`media me-2 media-${notifications.profile.bg}`}
                            >
                      ...
                      <li key={i}>
                        <div className="timeline-panel">
                          {message.profile.img ? (
                            ...
                            <div
                              className={`media me-2 media-${message.profile.bg}`}
                            >
                  ...
                  {widgetData &&
                    widgetData.todo.map((todo, i) => (
                      <li key={i}>
                        <div className="timeline-panel">
                          <div
                            className={`custom-control custom-checkbox checkbox-${todo.color} check-lg me-3`}
                          >
                            <input
                              type="checkbox"
              ...
              <div className="widget-stat card">
                <div className="card-body p-4">
                  <div className="media ai-icon">
                    <span
                      className={`me-3 bgl-${widget.color} text-${widget.color}`}
                    >
          ...
          <div className="card active_users">
            ...
            <div className="card-body pt-0">
              <div className="list-group-flush mt-4">
                <div className="list-group-item bg-transparent border-0 d-flex border-bottom justify-content-between px-0 py-1 font-weight-semi-bold border-top-0">
                ...
                {widgetData &&
                  widgetData.activeUser.map((active, i) => (
                    <div
                      className="list-group-item bg-transparent d-flex justify-content-between border-0 border-bottom px-0 py-2"
                      key={i}
                    >
              ...
              {widgetData &&
                widgetData.profile.checkups.data.map((checkup, i) => (
                  <li
                    ...
                    key={i}
                  >
                    <span className="mb-0 text-white">{checkup.name} :</span>
                    <strong className="text-white">{checkup.value}</strong>
                  </li>
                ))}
            </ul>
          </div>
              ...
              <div className="card overflow-hidden">
                ...
                <div className="row">
                  <div className="col-6 border-end">
                    <div className="pt-3 pb-3 pl-0 pe-0 text-center">
                      <h4 className="m-1">
