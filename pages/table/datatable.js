              ...
              <div className="table-responsive">
                ...
                >
                  ...
                  >
                    <table
                      id="basicDataTable"
                      className="display dataTable w-100 customer-table-data "
                    >
                      <thead>
                        <tr role="row">
                ...
                <div id="example2_wrapper" className="dataTables_wrapper">
                  <div className="dataTables_scroll">
                    <div className="dataTables_scrollBody">
                      <table id="example2" className="display dataTable w-100 customer-table-data ">
                        <thead>
                          <tr role="row">
                            <th className="">
              ...
              >
                <div className="table-responsive">
                  ...
                  >
                    <table
                      id="patientDataTable"
                      className="display dataTable no-footer w-100 customer-table-data "
                    >
                      <thead>
                        <tr role="row">
                          <th className="">
                          ...
                          <th className="">Patient ID</th>
                          <th className="">Date Check in</th>
                          <th className="">Patient Name</th>
                          <th className="">Doctor Assgined</th>
                          ...
                          patientTable.map((table, i) => (
                            <tr role="row" className="even" key={i}>
                              ...
                              <td>
                                ...
                                >
                                  <i
                                    className={`fa fa-circle text-${table.status.color} me-1`}
                                  />
                                  {table.status.text}
                                </span>
                              </td>
