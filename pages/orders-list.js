        ...
        <Tab.Container defaultActiveKey="AllStatus">
          <div className="card bg-transparent shadow-none">
            <div className="card-header flex-wrap border-0 p-0 justify-content-start">
              <div className="table-tabs me-2 mb-3 me-auto">
              ...
              <Dropdown className="select-drop">
                <Dropdown.Toggle
                  variant=""
                  id="dropdown-basic"
                  className="select-drop-btn form-control border-0 c-pointer style-1 me-3  default-select mb-3 border border-primary  text-primary p6 "
                  style={{
                    fontSize: "14px",
                    fontWeight: "400",
                    color: "#F9730D",
              ...
              <Dropdown className="select-drop">
                <Dropdown.Toggle
                  variant=""
                  id="dropdown-basic2"
                  className="select-drop-btn form-control p6 border-0 c-pointer style-1 me-3 p-1 default-select mb-3 border border-primary p-2 text-primary"
                  style={{
                    fontSize: "14px",
                    fontWeight: "400",
                    color: "#F9730D",
