                      ...
                      {customerList &&
                        customerList.map((customer, i) => (
                          <tr className="btn-reveal-trigger" key={i}>
                            ...
                            <td className="py-2">
                              {" "}
                              <Link href={`tel:${customer.phn}`}>{customer.phn}</Link>
                            </td>
                            ...
                            <td className="py-2 text-right">
                              <Dropdown>
                                ...
                                >
                                  <div className="py-2">
                                    <Link href="" scroll={ false} className="dropdown-item">Edit</Link>
                                    <Link href="" scroll={ false} className="dropdown-item text-danger">
                                        Delete                                      
                                    </Link>
                                  </div>
                                </Dropdown.Menu>
