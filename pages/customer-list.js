      ...
      <div className="col-xl-12">
        <div className="d-flex flex-wrap mb-3">
          <Link href="" scroll={ false}                          
              ...
              className="btn btn-outline-primary  me-auto mb-2"
          ...
          <Dropdown className="select-drop">
            <Dropdown.Toggle
              variant=""
              id="dropdown-basic"
              className="select-drop-btn form-control border-0 c-pointer style-1 me-3 p-1 default-select mb-3 border border-primary p-2 text-primary"
              style={{
                fontSize: "14px",
                fontWeight: "400",
                color: "#F9730D",
        ...
        <div className="table-responsive">
          ...
          >
            <div
              ...
              className="dataTables_wrapper no-footer customer-table-data"
            >
              <table
                id="customerList"
              ...
              >
                <thead>
                  <tr className="bg-primary" role="row">
                    <th className="sorting_1 pl-0 pe-0 text-center no-data-img">
                    ...
                    customerList.map((d, i) => (
                      <tr role="row" className="odd" key={i}>
                        <td className="p-0 text-center sorting_1">
                          <div className="custom-control custom-checkbox ms-2 customerAllCheckBox">
                            <input
                              type="checkbox"
                              className="form-check-input"
                              id={`customCheckBox${i}`}
                        ...
                        <td>
                          <Dropdown className="ms-auto">
                            ...
                            <Dropdown.Menu alignRight={true}>
                              <Dropdown.Item className="text-black" href="#">
                                Accept order
                              </Dropdown.Item>
                              <Dropdown.Item className="text-black" href="#">
                                Reject order
