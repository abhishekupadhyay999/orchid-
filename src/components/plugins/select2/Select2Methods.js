    ...
    <div className="col-xl-6">
      <div className="card">
        <div className="card-body">
          ...
          <button
            className="js-programmatic-open btn btn-primary mb-2 me-1"
            onClick={() => setIsOpen(true)}
          >
            Open
          </button>
          <button
            className="js-programmatic-close btn btn-primary mb-2 me-1"
            onClick={() => setIsOpen(false)}
          >
            Close
          </button>
          <button
            className="js-programmatic-destroy btn btn-primary me-1 mb-2"
            onClick={() => setIsDistory(true)}
          >
            Destroy
          </button>
          <button
            className="js-programmatic-init btn btn-primary mb-2 me-1"
