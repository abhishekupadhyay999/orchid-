        ...
        >
          <div className="row">
            <div className="col-xl-6">
              ...
              <div className="mb-3 row">
                <label className="col-lg-4 col-form-label form-label" htmlFor="val-email">
            ...
            <div className="col-xl-6">
              <div className="mb-3 row">
                <label className="col-lg-4 col-form-label form-label" htmlFor="val-skill">
                  Best Skill
                  <span className="text-danger"> *</span>
                </label>
                <div className="col-lg-6">
              ...
              <div className="mb-3 row">
                <label className="col-lg-4 col-form-label form-label" htmlFor="val-digits">
              ...
              <div className="mb-3 row">
                <label className="col-lg-4 col-form-label form-label" htmlFor="val-number">
              ...
              <div className="mb-3 row">
                <label className="col-lg-4 col-form-label form-label" htmlFor="val-range">
                  Range [1, 5]
                  <span className="text-danger"> *</span>
                </label>
                <div className="col-lg-6">
                ...
                <div className="col-lg-8">
                  ...
                  >
                    <input
                      ...
                      value={values.terms}
                    />
                    <span className="css-control-indicator" /> Agree to terms and conditions
                  </label>
                  <div
                    id="val-username1-error"
                    className="invalid-feedback animated fadeInUp"
